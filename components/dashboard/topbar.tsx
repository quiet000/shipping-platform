...
export function Topbar({ onMenuClick, title }: TopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b border-slate-200 bg-white/80 px-4 backdrop-blur dark:border-slate-700 dark:bg-slate-900/80 sm:px-6">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <div className="relative">
          ...
          >
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-navy-900 text-xs font-black text-white dark:bg-sky-600">
          ...
          {menuOpen && (
            <>
              ...
              />
              <div className="absolute left-0 top-full z-20 mt-2 w-52 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
                <button
                  onClick={() => {
                    setMenuOpen(false);
                    setPwOpen(true);
                ...
                <button
                  ...
                  className="flex w-full items-center gap-2.5 border-t border-slate-100 px-4 py-3 text-sm font-semibold text-red-600 transition hover:bg-red-50 dark:border-slate-700 dark:hover:bg-red-500/10"
                >
